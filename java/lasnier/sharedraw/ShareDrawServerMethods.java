...
public interface ShareDrawServerMethods {
  ...
  public void load( String ref) throws lasnier.sharedraw.RemoteException;

  public void saveKompressed( String ref) throws lasnier.sharedraw.RemoteException;

  public void loadExpanded( String ref) throws lasnier.sharedraw.RemoteException;

  public void reset() throws lasnier.sharedraw.RemoteException;

    /*
  public void addRemoteClient( ShareDrawClientMethods client) throws
